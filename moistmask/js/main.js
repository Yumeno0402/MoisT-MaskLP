...
window.addEventListener("load", () => {
  ...
  // ======================
  // user-wide：タイトル＋線（左右から伸びる）
  // ======================
  const userWideTitleTl = gsap.timeline({
    scrollTrigger: {
      trigger: ".user-wide",
  ...
  // ======================
  // user-wide：アイコン6つ（順番にふわっと）
  // ======================
  gsap.to(".user-wide__item", {
    scrollTrigger: {
      trigger: ".user-wide__grid",
  ...
  // ======================
  // user-wide：ビジュアル画像（ふわっと）
  // ======================
  gsap.to(".user-wide__visual-img", {
    scrollTrigger: {
      trigger: ".user-wide__visual",
      start: isSp ? "top 92%" : "top 80%",
      once: true,
    },
    opacity: 1,
